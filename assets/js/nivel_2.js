class Nivel_2 extends Phaser.Scene {
    ...
    create(){
        ...
        Funciones.initEnemigo(this, (Math.PI / 2) - (Math.PI / 4));
    ...
    initColliders() {
        ...
        this.physics.add.collider(pelota, col, Funciones.patear, null, this);
        this.physics.add.collider(jugador, col, null, null, this);
        this.physics.add.collider(enemigo, col, Funciones.rotarEnemigo, null, this);
        ...
        this.physics.add.collider(pelota, cole, Funciones.patear, null, this);
        this.physics.add.collider(jugador, cole, null, null, this);
        this.physics.add.collider(enemigo, cole, Funciones.rotarEnemigo, null, this);
    }
